 ...
 * @link       https://github.com/TGMPA/Jankx\Plugin
 */
 ...
 *
 * Parent Theme:
 * require_once get_template_directory() . '/path/to/class-Jankx\Plugin.php';
 *
 * Child Theme:
 * require_once get_stylesheet_directory() . '/path/to/class-Jankx\Plugin.php';
 *
 * Plugin:
 * require_once dirname( __FILE__ ) . '/path/to/class-Jankx\Plugin.php';
 */
require_once get_template_directory() . '/path/to/class-Jankx\Plugin.php';

add_action('tgmpa_register', 'jankx__register_required_plugins');
 ...
 */
function jankx__register_required_plugins()
{
    /*
     ...
     */
    $config = array(
        'id'           => 'jankx',                 // Unique ID for hashing notices for multiple instances of TGMPA.
